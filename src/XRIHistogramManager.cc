...
void XRIHistogramManager::Book()
{
  ...
  G4int ih = analysisManager->CreateH1("h1.1", "Energy spectrum : Incident on crystal", 1000, 0.*keV, 120.*keV, "keV");
  analysisManager->SetH1Activation(ih, true);

  ih = analysisManager->CreateH2("h2.1","Plane-1 : Position distribution x vs. y", 500, -100.*mm, 100.*mm, 500, -100.*mm, 100.*mm, "mm", "mm");
