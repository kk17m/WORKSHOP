...
//
//
/// \file XRIRunAction.cc
/// \brief Implementation of the XRIRunAction class
...
G4Run* XRIRunAction::GenerateRun()
{
  fRun = new XRIRun();
  return fRun;
}
...
void XRIRunAction::EndOfRunAction(const G4Run* run)
{
    ...
    const XRIPrimaryGeneratorAction* generatorAction
            = static_cast<const XRIPrimaryGeneratorAction*>
